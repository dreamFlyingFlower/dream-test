...
public class DefaultUniqueTicketIdGenerator implements UniqueTicketIdGenerator {
	 ...
	 *
	 * @param maxLength the maximum length of the random string used to generate the
	 *        id.
	 */
	...
	public String getNewTicketId(final String prefix) {
		...
		final StringBuilder buffer =
				new StringBuilder(prefix.length() + 2 + (StringUtils.isNotBlank(this.suffix) ? this.suffix.length() : 0)
