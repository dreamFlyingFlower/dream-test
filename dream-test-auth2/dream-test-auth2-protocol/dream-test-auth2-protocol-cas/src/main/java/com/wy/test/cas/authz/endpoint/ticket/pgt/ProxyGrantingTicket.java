...
import com.wy.test.cas.authz.endpoint.ticket.ExpirationPolicy;
import com.wy.test.cas.authz.endpoint.ticket.Service;
import com.wy.test.cas.authz.endpoint.ticket.TicketGrantingTicket;

/**
 * Interface for a proxy granting ticket. A proxy-granting ticket is an opaque string that is used by a service to
 * obtain proxy tickets for obtaining access to a back-end service on behalf of a client. Proxy-granting tickets are
