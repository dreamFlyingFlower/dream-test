...
import com.wy.test.cas.authz.endpoint.response.Service10ResponseBuilder;
...
public class Cas10AuthorizeEndpoint extends CasBaseAuthorizeEndpoint {
	 ...
	 * @return
	 * 
	 *         2.4. /validate [CAS 1.0] /validate checks the validity of a service
	 *         ticket. /validate is part of the CAS 1.0 protocol and thus does not
	 *         handle proxy authentication. CAS MUST respond with a ticket
	 *         validation failure response when a proxy ticket is passed to
	 *         /validate.
	 * 
	 * 
	 *         2.4.1. parameters The following HTTP request parameters MAY be
	 *         specified to /validate. They are case sensitive and MUST all be
	 *         handled by /validate.
	 * 
	 ...
	 * 
	 * 
	 *         2.4.2. response /validate will return one of the following two
	 *         responses: On ticket validation success: yes<LF> username<LF>
	 * 
