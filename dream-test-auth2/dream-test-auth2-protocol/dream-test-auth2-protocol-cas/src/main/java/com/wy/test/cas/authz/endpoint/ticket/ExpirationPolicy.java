...
public interface ExpirationPolicy extends Serializable {
	...
	/**
	 * Describes the time duration where this policy should consider the item alive. Once this time passes, the item is
	 * considered expired and dead.
	 *
	 ...
	 *
	 * @return idle time in seconds. A zero value indicates the time duration is not supported or is inactive. Unit of
	 *         measure is defined by the implementation.
	 */
	Long getTimeToIdle();
