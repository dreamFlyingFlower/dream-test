...
public interface ExpirationPolicy extends Serializable {
	 ...
	 *
	 * @param ticketState The snapshot of the current ticket state
	 * @return The time to live in seconds. A zero value indicates the time duration
	 ...
	 *
	 * @return time to live in seconds. A zero value indicates the time duration is
	 *         not supported or is inactive.
	 */
	Long getTimeToLive();
	 ...
	 *
	 * @return idle time in seconds. A zero value indicates the time duration is not
	 *         supported or is inactive. Unit of measure is defined by the
	 *         implementation.
	 */
	Long getTimeToIdle();
