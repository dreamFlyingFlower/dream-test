...
import com.wy.test.oauth2.provider.OAuth2UserDetailsService;
import com.wy.test.oauth2.provider.approval.TokenApprovalStore;
import com.wy.test.oauth2.provider.approval.endpoint.OAuth20UserApprovalHandler;
...
import com.wy.test.oauth2.provider.code.AuthorizationCodeServices;
import com.wy.test.oauth2.provider.code.AuthorizationCodeServicesFactory;
import com.wy.test.oauth2.provider.endpoint.TokenEndpointAuthenticationFilter;
