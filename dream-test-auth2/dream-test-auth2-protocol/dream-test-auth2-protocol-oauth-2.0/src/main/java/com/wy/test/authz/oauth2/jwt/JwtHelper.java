...
import static com.wy.test.authz.oauth2.jwt.JwtAlgorithms.sigAlg;
import static com.wy.test.authz.oauth2.jwt.codec.Codecs.b64UrlDecode;
import static com.wy.test.authz.oauth2.jwt.codec.Codecs.b64UrlEncode;
import static com.wy.test.authz.oauth2.jwt.codec.Codecs.concat;
import static com.wy.test.authz.oauth2.jwt.codec.Codecs.utf8Decode;
import static com.wy.test.authz.oauth2.jwt.codec.Codecs.utf8Encode;
...
public class JwtHelper {
	 ...
	 *
	 * @param token the (non-null) encoded token (three Base-64 encoded strings
...
class JwtImpl implements Jwt {
	 ...
	 * @param content the base64-decoded "claims" segment (may be encrypted,
