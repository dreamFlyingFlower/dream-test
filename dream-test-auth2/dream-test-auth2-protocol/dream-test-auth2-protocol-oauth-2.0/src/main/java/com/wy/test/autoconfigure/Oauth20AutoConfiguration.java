...
import com.wy.test.authz.oauth2.provider.OAuth2UserDetailsService;
import com.wy.test.authz.oauth2.provider.approval.TokenApprovalStore;
import com.wy.test.authz.oauth2.provider.approval.endpoint.OAuth20UserApprovalHandler;
...
import com.wy.test.authz.oauth2.provider.code.AuthorizationCodeServices;
import com.wy.test.authz.oauth2.provider.code.AuthorizationCodeServicesFactory;
import com.wy.test.authz.oauth2.provider.endpoint.TokenEndpointAuthenticationFilter;
...
import com.wy.test.authz.oauth2.provider.token.store.JwtAccessTokenConverter;
import com.wy.test.authz.oauth2.provider.token.store.TokenStoreFactory;
import com.wy.test.authz.oidc.idtoken.OIDCIdTokenEnhancer;
...
public class Oauth20AutoConfiguration implements InitializingBean {
	...
	OIDCIdTokenEnhancer tokenEnhancer(OIDCProviderMetadataDetails oidcProviderMetadata,
