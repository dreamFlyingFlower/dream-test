...
import com.wy.test.authz.oauth2.common.OAuth2Constants.CODE_CHALLENGE_METHOD_TYPE;
...
public class AuthorizationCodeTokenGranter extends AbstractTokenGranter {
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		String redirectUriApprovalParameter =
				pendingOAuth2Request.getRequestParameters().get(OAuth2Constants.PARAMETER.REDIRECT_URI);
