...
import com.wy.test.authz.oauth2.provider.CompositeTokenGranter;
import com.wy.test.authz.oauth2.provider.OAuth2RequestFactory;
import com.wy.test.authz.oauth2.provider.TokenGranter;
import com.wy.test.authz.oauth2.provider.client.ClientCredentialsTokenGranter;
import com.wy.test.authz.oauth2.provider.code.AuthorizationCodeServices;
import com.wy.test.authz.oauth2.provider.code.AuthorizationCodeTokenGranter;
import com.wy.test.authz.oauth2.provider.code.InMemoryAuthorizationCodeServices;
import com.wy.test.authz.oauth2.provider.implicit.ImplicitTokenGranter;
import com.wy.test.authz.oauth2.provider.password.ResourceOwnerPasswordTokenGranter;
