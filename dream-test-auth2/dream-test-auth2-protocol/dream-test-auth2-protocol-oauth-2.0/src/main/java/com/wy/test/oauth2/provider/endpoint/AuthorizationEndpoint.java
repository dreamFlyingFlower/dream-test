...
import com.wy.test.oauth2.provider.OAuth2RequestValidator;
import com.wy.test.oauth2.provider.TokenRequest;
import com.wy.test.oauth2.provider.approval.DefaultUserApprovalHandler;
import com.wy.test.oauth2.provider.approval.UserApprovalHandler;
