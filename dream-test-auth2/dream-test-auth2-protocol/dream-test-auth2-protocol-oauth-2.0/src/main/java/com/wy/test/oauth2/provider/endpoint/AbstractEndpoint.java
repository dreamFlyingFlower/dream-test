...
import com.wy.test.oauth2.provider.TokenGranter;
import com.wy.test.oauth2.provider.client.ClientCredentialsTokenGranter;
import com.wy.test.oauth2.provider.code.AuthorizationCodeServices;
import com.wy.test.oauth2.provider.code.AuthorizationCodeTokenGranter;
import com.wy.test.oauth2.provider.code.InMemoryAuthorizationCodeServices;
import com.wy.test.oauth2.provider.implicit.ImplicitTokenGranter;
import com.wy.test.oauth2.provider.password.ResourceOwnerPasswordTokenGranter;
