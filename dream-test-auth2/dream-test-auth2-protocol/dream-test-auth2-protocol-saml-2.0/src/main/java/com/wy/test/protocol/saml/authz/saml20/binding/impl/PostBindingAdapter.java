...
import com.wy.test.protocol.saml.authz.saml.common.AuthnRequestInfo;
import com.wy.test.protocol.saml.authz.saml.common.TrustResolver;
import com.wy.test.protocol.saml.authz.saml20.binding.BindingAdapter;
...
public class PostBindingAdapter implements BindingAdapter, InitializingBean {
	...
	public void sendSAMLMessage(SignableSAMLObject samlMessage, Endpoint endpoint, HttpServletRequest request,
	...
	public Credential buildSPSigningCredential() throws Exception {
		...
		KeyStoreCredentialResolver credentialResolver = trustResolver.buildKeyStoreCredentialResolver(trustKeyStore,
				getSaml20Details().getEntityId(), getKeyStoreLoader().getKeystorePassword());
	...
	@Override
	public AppSamlDetailVO getSaml20Details() {
