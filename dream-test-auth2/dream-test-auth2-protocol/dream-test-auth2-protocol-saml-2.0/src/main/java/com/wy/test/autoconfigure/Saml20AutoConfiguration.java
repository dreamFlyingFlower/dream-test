...
import com.wy.springframework.ui.velocity.VelocityEngineFactoryBean;
...
import com.wy.test.authz.saml20.binding.decoder.OpenHTTPPostDecoder;
import com.wy.test.authz.saml20.binding.decoder.OpenHTTPPostSimpleSignDecoder;
import com.wy.test.authz.saml20.binding.decoder.OpenHTTPRedirectDecoder;
import com.wy.test.authz.saml20.binding.impl.ExtractPostBindingAdapter;
import com.wy.test.authz.saml20.binding.impl.ExtractRedirectBindingAdapter;
import com.wy.test.authz.saml20.binding.impl.PostBindingAdapter;
...
public class Saml20AutoConfiguration implements InitializingBean {
	...
	String issuerEntityName(@Value("${maxkey.saml.v20.idp.issuer}") String issuerEntityName) {
		return issuerEntityName;
	}
	...
	Saml20Metadata saml20Metadata(@Value("${maxkey.saml.v20.metadata.orgName}") String orgName,
	...
	BasicParserPool samlParserPool(@Value("${maxkey.saml.v20.max.parser.pool.size}") int maxPoolSize) {
