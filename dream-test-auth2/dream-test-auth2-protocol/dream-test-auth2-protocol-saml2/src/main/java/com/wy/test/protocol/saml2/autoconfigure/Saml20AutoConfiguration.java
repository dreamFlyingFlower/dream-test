package com.wy.test.protocol.saml2.autoconfigure;
...
import com.wy.test.protocol.saml2.saml.common.EndpointGenerator;
import com.wy.test.protocol.saml2.saml.service.IDService;
import com.wy.test.protocol.saml2.saml.service.TimeService;
import com.wy.test.protocol.saml2.saml20.binding.decoder.OpenHTTPPostDecoder;
import com.wy.test.protocol.saml2.saml20.binding.decoder.OpenHTTPPostSimpleSignDecoder;
import com.wy.test.protocol.saml2.saml20.binding.decoder.OpenHTTPRedirectDecoder;
import com.wy.test.protocol.saml2.saml20.binding.impl.ExtractPostBindingAdapter;
import com.wy.test.protocol.saml2.saml20.binding.impl.ExtractRedirectBindingAdapter;
import com.wy.test.protocol.saml2.saml20.binding.impl.PostBindingAdapter;
import com.wy.test.protocol.saml2.saml20.binding.impl.PostSimpleSignBindingAdapter;
