package com.wy.test.protocol.saml2.authz.saml20.metadata.endpoint;
...
import com.wy.test.protocol.saml2.authz.saml20.metadata.MetadataGenerator;
	...
	public String metadata(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			descriptor.getSingleSignOnServices().add(metadataGenerator
					.getSingleSignOnService(WebContext.getContextPath(true) + "/authz/saml20/" + appId, null));

			descriptor.getSingleSignOnServices()
					.add(metadataGenerator.getSingleSignOnService(
							WebContext.getContextPath(true) + "/authz/saml20/" + appId,
