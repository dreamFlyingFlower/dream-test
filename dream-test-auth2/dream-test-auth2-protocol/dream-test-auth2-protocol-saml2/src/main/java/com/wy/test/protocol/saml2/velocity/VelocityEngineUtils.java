package com.wy.test.protocol.saml2.velocity;
...
public abstract class VelocityEngineUtils {
	 ...
	 * @param model the Map that contains model names as keys and model objects as
	 *        values
	 * @param writer the Writer to write the result to
	 * @throws VelocityException if the template wasn't found or rendering failed
	 * @deprecated Use
	 *             {@link #mergeTemplate(VelocityEngine, String, String, Map, Writer)}
	 *             instead, following Velocity 1.6's corresponding deprecation in
	 *             its own API.
	 */
	public static void mergeTemplate(VelocityEngine velocityEngine, String templateLocation, Map<String, Object> model,
