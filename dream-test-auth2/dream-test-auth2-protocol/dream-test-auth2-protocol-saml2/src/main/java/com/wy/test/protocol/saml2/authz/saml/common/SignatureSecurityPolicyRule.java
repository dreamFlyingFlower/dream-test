package com.wy.test.protocol.saml2.authz.saml.common;
...
public class SignatureSecurityPolicyRule implements InitializingBean, SecurityPolicyRule {
	...
	public SignatureSecurityPolicyRule(CredentialResolver credentialResolver,
	...
	private void checkMessageSignature(MessageContext messageContext, SignableSAMLObject samlMessage)
