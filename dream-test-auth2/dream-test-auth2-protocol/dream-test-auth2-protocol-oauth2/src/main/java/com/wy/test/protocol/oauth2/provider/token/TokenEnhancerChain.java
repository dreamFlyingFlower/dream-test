...
public class TokenEnhancerChain implements TokenEnhancer {
	 ...
	 * 
	 * @see com.wy.test.protocol.oauth2.provider.token.TokenEnhancer#enhance(com.wy.test.protocol.oauth2.common.OAuth2AccessToken,
	 *      com.wy.test.protocol.oauth2.provider.OAuth2Authentication)
	 */
	@Override
