...
public class UserAdjointController {
	...
	@ResponseBody
	public JpaPageResults<UserAdjunctEntity> queryDataGrid(
			@ModelAttribute("userInfoAdjoint") UserAdjunctEntity userInfoAdjoint, @CurrentUser UserEntity currentUser) {
	...
	public ModelAndView forwardUpdate(@PathVariable("id") String id) {
		...
		UserAdjunctEntity userInfoAdjoint = userInfoAdjointService.get(id);
