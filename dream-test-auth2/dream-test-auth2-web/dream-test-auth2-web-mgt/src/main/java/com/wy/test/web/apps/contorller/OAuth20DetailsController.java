...
public class OAuth20DetailsController extends BaseAppContorller {
	...
	public ResponseEntity<?> init() {
		AppOauthClientDetailEntity oauth20Details = new AppOauthClientDetailEntity();
		...
		return new Message<AppOauthClientDetailEntity>(oauth20Details).buildResponse();
	}
	...
	public ResponseEntity<?> get(@PathVariable("id") String id) {
		...
		AppOauthClientDetailEntity oauth20Details = new AppOauthClientDetailEntity(application, baseClientDetails);
	...
	public ResponseEntity<?> add(@RequestBody AppOauthClientDetailEntity oauth20Details, @CurrentUser UserEntity currentUser) {
	...
	public ResponseEntity<?> update(@RequestBody AppOauthClientDetailEntity oauth20Details, @CurrentUser UserEntity currentUser) {
