...
public class TimeBasedOTP {
	...
	/**
	 * This method generates a OTP value for the given set of parameters. Default Crypto HmacSHA512
	 * 
	...
	/*
	 * * This method generates a OTP value for the given set of parameters. Crypto HmacSHA1
	 * 
	 * @param key
	 * 
	 * @param time
	...
	/*
	 * * This method generates a OTP value for the given set of parameters. Crypto HmacSHA256
	 * 
	 * @param key: the shared secret, HEX encoded
	 * 
	 * @param time: a value that reflects a time
