package com.wy.test.authentication.otp.password.onetimepwd.algorithm;
...
/**
 * IETF RFC 4226 http://tools.ietf.org/html/rfc4226 HOTP Include HmacOTP's implement same as HmacOTP's, when addChecksum
 * = false & truncationOffset = -1
 *
 * @author 飞花梦影
 * @date 2024-07-16 09:39:34
...
public class HOTP {
	 ...
	 *        0 ... 15, then dynamic truncation will be used. Dynamic truncation is when the last 4 bits of the last
	 *        byte of the MAC are used to determine the start offset.
