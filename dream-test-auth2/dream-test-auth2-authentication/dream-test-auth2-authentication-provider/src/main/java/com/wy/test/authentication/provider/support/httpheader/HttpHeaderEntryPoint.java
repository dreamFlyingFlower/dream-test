package com.wy.test.authentication.provider.support.httpheader;
...
public class HttpHeaderEntryPoint implements AsyncHandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (!isAuthenticated) {
			LoginCredential loginCredential = new LoginCredential(httpHeaderUsername, "", AuthLoginType.HTTP_HEADER.getMsg());
