...
public final class NetUtil {
	...
	/**
	 * Download the given URL to a temporary local file. The temporary file is
	 * marked for deletion at exit.
	 * 
	 * @param url
	 * @return URL pointing to the temporary file, <code>url</code> itself if it's a
	 *         file: one.
	 * @throws IOException
	 */
	 ...
	 */
	public static URL toURL(Object obj) throws MalformedURLException {
