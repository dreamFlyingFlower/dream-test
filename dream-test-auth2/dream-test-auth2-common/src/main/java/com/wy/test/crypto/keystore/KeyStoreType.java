...
public enum KeyStoreType {
	...
	/**
	 * Does the keystore type provide useful values for entry creation dates? Some
	 * keystores return the keystore load time as creation date for all entries,
	 * this is not considered useful by this class.
	 * 
	 ...
	 * 
	 * @return filename extensions (without leading dot, in lower case), empty if
	 *         not applicable
	 */
