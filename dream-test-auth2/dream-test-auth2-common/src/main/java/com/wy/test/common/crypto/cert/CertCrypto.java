...
public class CertCrypto {
	 ...
	 * @throws Exception
	 */
	public static void encryptFileByPrivateKey(String srcFilePath, String destFilePath, KeyStore keyStore, String alias,
	 ...
	 * @throws Exception
	 */
	public static String encryptFileToBase64ByPrivateKey(String filePath, KeyStore keyStore, String alias,
			String password) throws Exception {
		byte[] encryptedData = encryptFileByPrivateKey(filePath, keyStore, alias, password);
		return Base64Helper.encodeString(encryptedData);
	}
	 ...
	 * @throws Exception
	 */
	public static byte[] encryptByPublicKey(byte[] data, Certificate certificate) throws Exception {
		// 取得公钥
	 ...
	 * @throws Exception
	 */
	public static byte[] decryptByPublicKey(byte[] encryptedData, Certificate certificate) throws Exception {
		PublicKey publicKey = KeyStoreUtil.getPublicKey(certificate);
		Cipher cipher = Cipher.getInstance(publicKey.getAlgorithm());
	...
	public static void main(String[] args) throws Exception {
		// String result = encryptFileToBase64ByPrivateKey("C:\\sp.cer",
		// "C:\\sp-keystore.jks", "sp", "secret");
		// System.out.println(result);
		// Certificate certificate = getCertificate("C:\\sp-keystore.jks", "sp",
		// "secret");
		...
		ks.load(new ByteArrayInputStream(Base64Helper.decode(b64EncodedKeystore)), keystorePassword.toCharArray());
