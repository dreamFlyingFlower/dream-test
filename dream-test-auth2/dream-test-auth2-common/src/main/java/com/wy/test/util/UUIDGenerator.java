...
public final class UUIDGenerator {
	...
	/**
	 * Toggle uuid generator into sequential mode, so the random segment is in order
	...
	/**
	 * Toggle uuid generator into variable mode, so the random segment is in reverse
	 * order and increases by a large increment. This is the default mode.
	 */
	 ...
	 * 
	 * @return millisecond UTC timestamp from generation of the UUID, or null for
	 *         unrecognized format
	 */
	...
	/**
	 * extract MAC address fragment from raw UUID bytes, setting missing values to
	 * 0, thus the first 2 and a half bytes will be 0, followed by 3 and a half
	 * bytes of the active MAC address when the UUID was generated
	 * 
