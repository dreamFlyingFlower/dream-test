 ...
 * </pre>
 *
 * Such that "salt" is the salt, md4 is the digest method, and password is the
 * actual password. For example with a password of "password", and a salt of
 * "thisissalt":
 *
 * <pre>
 ...
 * </pre>
 *
 * The format is intended to work with the Md4PasswordEncoder that was found in
 * the Spring Security core module. However, the passwords will need to be
