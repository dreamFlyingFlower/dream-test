...
public class XMLHelper {
	 ...
	 * These are: space, newline, carriage return, and tab.
	 */
	public static final String LIST_DELIMITERS = " \n\r\t";

	/**
	 * DOM configuration parameters used by LSSerializer in pretty print format
	 * output.
	 */
	 ...
	 * The written content is encoded using the encoding specified in the writer
	 * configuration.
	 * 
	 ...
	 * @param node the node to write out
	 * @param output the writer to write the XML to
	 * @param serializerParams parameters to pass to the {@link DOMConfiguration} of
	 *        the serializer instance, obtained via
	 *        {@link LSSerializer#getDomConfig()}. May be null.
	 */
	...
	/**
	 * Writes a Node out to an OutputStream using the DOM, level 3, Load/Save
	 * serializer. The written content is encoded using the encoding specified in
	...
	/**
	 * Obtain a the DOM, level 3, Load/Save serializer {@link LSSerializer} instance
	 * from the given {@link DOMImplementationLS} instance.
	 * 
	 * <p>
	 * The serializer instance will be configured with the parameters passed as the
	 * <code>serializerParams</code> argument. It will also be configured with an
	 * {@link LSSerializerFilter} that shows all nodes to the filter, and accepts
	 * all nodes shown.
	 * </p>
	 * 
