...
public class BeanUtil {
	...
	public static Boolean isPublicProperty(Object bean, String fieldName) {
		if (isSetProperty(bean.getClass(), fieldName) && isGetProperty(bean.getClass(), fieldName)) {
			return true;
		} else {
			return false;
		}
	...
	public static Object newInstance(String className)
		...
		return ReflectHelper.newInstance(className);
	}

	public static <T> Object newInstance(Class<T> cls) throws NoSuchMethodException, SecurityException,
			InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		return ReflectHelper.newInstance(cls);
	}

	public static Object newInstance(String className, Object[] args)
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException, ClassNotFoundException {
		return ReflectHelper.newInstance(className, args);
	}

	public static <T> T newInstance(Class<T> cls, Object[] args) throws NoSuchMethodException, SecurityException,
			InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		return ReflectHelper.newInstance(cls, args);
	}
	...
	public static String getMethodByProperty(String getOrSet, String property) {
		String methodName = getOrSet + (property.length() == 1 ? (Character.toUpperCase(property.charAt(0)) + "")
				: Character.toUpperCase(property.charAt(0)) + property.substring(1));
		// LogFactory.getLog(BeanUtils.class).debug("getMethodByProperty() methodName :
		// "+methodName);
		return methodName;
	}
