...
public final class RSAUtils {
	...
	public static String getBase64PEM(byte[] encoded) {
		String base64String = Base64.getMimeEncoder(PEM_ARRAY_SIZE, LINE_SEPARATOR.getBytes()).encodeToString(encoded);
		// StringBuffer base64ArrayString = new StringBuffer("");
		// int startPosition = 0;
		// int endPosition = PEM_ARRAY_SIZE;
		// while(endPosition < base64String.length()) {
		// base64ArrayString.append(base64String.substring(startPosition,
		// endPosition)).append("\n");
