 ...
 * </pre>
 *
 * Such that "salt" is the salt, digest is the digest method, and password is
 * the actual password. For example when using MD5, a password of "password",
 * and a salt of "thisissalt":
 *
 * <pre>
 ...
 * </pre>
 *
 * The format is intended to work with the DigestPasswordEncoder that was found
 * in the Spring Security core module. However, the passwords will need to be
 * migrated to include any salt with the password since this API provides Salt
 * internally vs making it the responsibility of the user. To migrate passwords
 * from the SaltSource use the following:
 *
 * <pre>
 * 
 ...
 * @author Luke Taylor
 * @author Rob Winch
 * @since 5.0 deprecated Digest based password encoding is not considered
 *        secure. Instead use an adaptive one way function like
...
public class MessageDigestPasswordEncoder implements PasswordEncoder {
	 ...
	 * "https://java.sun.com/j2se/1.4.2/docs/guide/security/CryptoSpec.html#AppA">
