...
public class PathUtils {
	...
	public PathUtils() {
		try {
			classPath = java.net.URLDecoder.decode(PathUtils.class.getResource(PATH_FILE_NAME).getFile(), "UTF-8");
		...
		_logger.trace("Properties Protocol:" + PathUtils.class.getResource("PathUtils.properties").getProtocol());
