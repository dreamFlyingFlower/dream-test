package com.wy.test.common.crypto.jose.keystore;
			...
			if (StringUtils.isNotBlank(mediaType) && mediaType.equalsIgnoreCase("XML")) {
				...
				for (JWK jwk : jwkSet.getKeys()) {
					...
					try {
						...
						metaDataString.append(DigestHelper.getPemPublicKey(publicKey.getEncoded()));
						metaDataString.append("</Modulus>").append("\n");
						// keyID
				...
				// RSA Only
				metaDataString.append(PrettyFactory.getJsonPretty().format(jwkSet.toPublicJWKSet().toString()));
			}
		} else {
