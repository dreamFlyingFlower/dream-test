...
public final class KeyPairUtil {
	 ...
	 */
	public static KeyPair genKeyPair(KeyPairType keyPairType, int keySize)
			throws CryptoException, NoSuchProviderException {
		try {
	...
	public static KeyPair genKeyPair(KeyPairType keyPairType, String provider)
			throws CryptoException, NoSuchProviderException {
	 ...
	 * @throws NoSuchProviderException
	 */
	public static KeyPair genKeyPair(KeyPairType keyPairType, String provider, int keySize)
			throws CryptoException, NoSuchProviderException {
		try {
