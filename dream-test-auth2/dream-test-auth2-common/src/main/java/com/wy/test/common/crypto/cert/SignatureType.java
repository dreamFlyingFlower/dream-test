 ...
 * 
 * @see <a href=
 *      "http://download.oracle.com/javase/6/docs/technotes/guides/security/StandardNames.html">JCA
 *      Standard Names</a>
 */
public enum SignatureType {
	...
	static {
		HashMap<KeyPairType, Collection<SignatureType>> kpMap = new HashMap<KeyPairType, Collection<SignatureType>>();

		// X509V1CertificateGenerator doesn't like SHA384withDSA and SHA512withDSA as of
		// BC 1.44
		kpMap.put(KeyPairType.DSA, Collections.unmodifiableSet(EnumSet.of(SHA1withDSA, SHA224withDSA, SHA256withDSA)));

		kpMap.put(KeyPairType.RSA,
				Collections
						.unmodifiableSet(EnumSet.of(MD2withRSA, MD5withRSA, SHA1withRSA, SHA224withRSA, SHA256withRSA,
	...
	/**
	 * Gets a string representation of signature type corresponding to the given
	 * object identifier.
	 * 
	 * @param oid the object identifier
	 * @return the corresponding signature type as string, <code>oid</code> itself
	 *         if unknown
	 */
