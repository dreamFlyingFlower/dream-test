 ...
 * 
 * @author 飞花梦影
 * @date 2024-07-14 21:32:57
 * @git {@link https://github.com/dreamFlyingFlower}
 */
public class StringUtil {

	/**
	 * Convert the supplied object to hex characters sub-divided by spaces every
	 * given number of characters, and left-padded with zeros to fill group size.
	 * 
	 ...
	 * @return Hex string
	 * @throws IllegalArgumentException if obj is not a BigInteger, byte array, or a
	 *         DERInteger, or groupSize &lt; 0
	 */
