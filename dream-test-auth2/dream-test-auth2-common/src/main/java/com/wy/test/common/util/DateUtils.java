...
//		System.out.println(zonedDateTime);
		...
		ZonedDateTime zonedDateTime1 = ZonedDateTime.ofInstant(date.toInstant(), ZoneOffset.UTC);
		LocalDateTime localDateTime = LocalDateTime.ofInstant(zonedDateTime1.toInstant(), ZoneOffset.UTC);
		System.out.println(localDateTime);
		String formatDateTime = DateTimeHelper.formatDateTime(localDateTime);
		LocalDateTime localDateTime2 = DateTimeHelper.parse(formatDateTime);
		System.out.println(localDateTime2);
		System.out.println(DateTimeHelper.local2Date(localDateTime2, ZoneOffset.UTC));
		
		
		
//		
//		ZonedDateTime withZoneSameLocal = zonedDateTime.withZoneSameInstant(ZoneOffset.UTC);
//		System.out.println(withZoneSameLocal);
		
		
//		ZonedDateTime withZoneSameLocal2 = zonedDateTime.withZoneSameLocal(ZoneOffset.UTC);
//		System.out.println(Date.from(withZoneSameLocal2.toInstant()));
//		System.out.println("++++++++++++++++");
//		System.out.println(Date.from(zonedDateTime.toInstant()));
//		LocalDateTime localDateTime = DateTimeHelper.toUtcDateTime(zonedDateTime);
//		System.out.println(DateTimeHelper.local2Date(localDateTime, ZoneOffset.UTC));

		LocalDateTime now = LocalDateTime.now();
		ZonedDateTime atZone = now.atZone(ZoneOffset.systemDefault());
		LocalDateTime ofInstant = LocalDateTime.ofInstant(atZone.toInstant(), ZoneOffset.UTC);
		System.out.println(ofInstant);

		System.out.println("++++++++++++++++");

		System.out.println(DateTimeHelper.date2Local(date));
//		System.out.println(DateTimeHelper.local2Date(localDateTime));
	}
	//
	...
	// *
	// * @param stringValue1 Date 1 as string value.
	// * @param stringValue2 Date 2 as string value.
	// *
