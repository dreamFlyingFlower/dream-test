package com.wy.test.core.entity.apps.oauth2.provider;
...
public interface ClientDetails extends Serializable {
	...
	/**
	 * Get the authorities that are granted to the OAuth client. Note that these are
	 * NOT the authorities that are granted to the user with an authorized access
	...
	/**
	 * The refresh token validity period for this client. Zero or negative for
	 * default value set by token service.
	 * 
