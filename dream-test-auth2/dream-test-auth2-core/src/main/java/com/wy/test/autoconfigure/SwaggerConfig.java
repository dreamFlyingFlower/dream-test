...
public class SwaggerConfig {
	...
	GroupedOpenApi userApi() {
		...
		return GroupedOpenApi.builder().group(title).pathsToMatch(paths).packagesToScan(packagedToMatch).build();
	}
	...
	OpenAPI docOpenAPI() {
		return new OpenAPI()
				...
				.externalDocs(new ExternalDocumentation().description("MaxKey.top contact support@maxsso.net")
