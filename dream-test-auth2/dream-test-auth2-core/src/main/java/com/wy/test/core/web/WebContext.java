...
public final class WebContext {
	...
	public static final String getRequestIpAddress(HttpServletRequest request) {
		...
		LogFactory.getLog(WebContext.class).trace("getRequestIpAddress() RequestIpAddress:" + ipAddress);
		return ipAddress;
	}
	...
	public static boolean captchaValid(String captcha) {
		if (captcha == null
				|| !captcha.equals(WebContext.getSession().getAttribute(WebConstants.KAPTCHA_SESSION_KEY).toString())) {
			return false;
		}
		return true;
	}
