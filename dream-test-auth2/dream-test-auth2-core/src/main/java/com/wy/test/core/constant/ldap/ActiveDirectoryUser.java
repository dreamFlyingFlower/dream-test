package com.wy.test.core.constant.ldap;
...
/**
 * ActiveDirectoryUser objectclass attribute top -> person ->
...
public class ActiveDirectoryUser {
	...
	public static ArrayList<String> OBJECTCLASS =
			new ArrayList<>(Arrays.asList("top", "person", "organizationalPerson", "user"));

	public static String objectClass = "user";

	/**
	 * userAccountControl值得说明 http://support.microsoft.com/zh-cn/kb/305144
	...
	public static class userAccountControl {
		...
		public static final int PASSWD_CANT_CHANGE = 0x0040;// 64 You can't assign this permission by directly modifying
															// the UserAccountControl attribute. For information about
															// how to set the permission programmatically, see the
															// Property flag descriptions section.
	...
	/*
	 * 常规 名 First Name givenName 姓 Last Name/SurName sn 英文缩写 Initials initials 描述
	 * Description description 办公室 Office physicalDeliveryOfficeName 电话号码 Telephone
	 * Number telephoneNumber 电话号码 Telephone: Other otherTelephone 电子邮件 E-Mail mail
	 * 网页 Web Page wwwHomePage Web Page: Other url
	 * 
	 * 家庭电话 Home telephoneNumber Home: Other otherTelephone 寻呼机 Pager pager Pager:
	 * Other pagerOther 移动电话 Mobile mobile Mobile: Other otherMobile 传真 Fax
	 * facsimileTelephoneNumber Fax: Other otherFacsimileTelephoneNumber IP电话 IP
	 * phone ipPhone IP phone: Other otherIpPhone 注释 Notes info 帐号 用户登录名 UserLogon
	 * Name userPrincipalName 用户登录名（以前版本）User logon name (pre-Windows 2000)
	 * sAMAccountname 登录时间 Logon Hours logonHours 登录到 Log On To logonWorkstation
	 * 用户帐户控制 Account is locked out userAccountControl (启用：512，禁用：514， 密码永不过期：66048)
	 * Other Account Options userAccountControl User must change password at next
	 * logon pwdLastSet User cannot change password N/A 帐户过期 Account Expires
	 * accountExpires
	 *
	 * 地址 街道 Street streetAddress 邮政信箱 P.O.Box postOfficeBox 邮政编码 Zip/Postal Code
	 * postalCode 市/县 City l 省/自治区 State/Province st 国家/地区 Country/Region c,co, and
	 * countryCode
	 *
	 * 单位 职务 Title title 部门 Department department 公司 Company company 经理 Manager:Name
	 * manager 直接汇报人 Direct Reports directReports
	 *
	 * 成员 成员组 Member of memberOf 主要组 Set Primary Group primaryGroupID
	 */
