...
public interface HistoryLoginConvert extends BaseConvert<HistoryLoginEntity, HistoryLoginVO> {

	HistoryLoginConvert INSTANCE = Mappers.getMapper(HistoryLoginConvert.class);
}