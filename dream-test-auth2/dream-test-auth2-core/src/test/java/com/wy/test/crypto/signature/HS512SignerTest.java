...
public class HS512SignerTest {
	...
	public static void main(String[] args) throws JOSEException, ParseException {
		...
		OctetSequenceKey octKey = new OctetSequenceKey.Builder(secret).keyID("mxk_auth_jwk_secret")
				.keyUse(KeyUse.SIGNATURE).algorithm(JWSAlgorithm.HS512).build();
		...
		boolean isVerifier =
				verifier.verify(jwsObjected.getHeader(), jwsObjected.getSigningInput(), jwsObjected.getSignature());
