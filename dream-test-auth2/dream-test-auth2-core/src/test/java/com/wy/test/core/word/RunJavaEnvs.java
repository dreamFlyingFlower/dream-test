...
public class RunJavaEnvs {
	...
	public static void main(String[] args) {
		...
		System.out.println("OS : " + SystemUtils.OS_NAME + "(" + SystemUtils.OS_ARCH + " "
				+ ArchUtils.getProcessor().getType() + "), version " + SystemUtils.OS_VERSION + "");
		System.out.println("JAVA : " + SystemUtils.JAVA_VENDOR + " java version " + SystemUtils.JAVA_VERSION
				+ ", class " + SystemUtils.JAVA_CLASS_VERSION);
		System.out.println("JAVA_VM : " + SystemUtils.JAVA_VM_NAME + " (build " + SystemUtils.JAVA_VM_VERSION + ", "
